...
namespace Valve.VR
{
    public class SteamVR_ExternalCamera : MonoBehaviour
    {
        ...
        public void AttachToCamera(SteamVR_Camera steamVR_Camera)
        {
            ...
            colorMat = new Material(ShaderLoader.GetShader("Custom/SteamVR_ColorOut"));
            alphaMat = new Material(ShaderLoader.GetShader("Custom/SteamVR_AlphaOut"));
            clipMaterial = new Material(ShaderLoader.GetShader("Custom/SteamVR_ClearAll"));
