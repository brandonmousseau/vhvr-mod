...
namespace ValheimVRMod.Patches
{
    ...
    class PatchDoMeleeAttack
    {
        ...
        private static MethodInfo getLevelDamageFactorMethod = AccessTools.Method(typeof(Attack), "GetLevelDamageFactor");
         ...
         )
        {
          Vector3 zero = Vector3.zero;
            ...
            if (!((UnityEngine.Object) hitObject == (UnityEngine.Object) ___m_character.gameObject))
            {
              Vagon component1 = hitObject.GetComponent<Vagon>();
              if (!(bool) (UnityEngine.Object) component1 || !component1.IsAttached((Character) ___m_character))
              {
                Character component2 = hitObject.GetComponent<Character>();
                if (!((UnityEngine.Object) component2 != (UnityEngine.Object) null) || (___m_character.IsPlayer() || BaseAI.IsEnemy((Character) ___m_character, component2)) && (!___m_weapon.m_shared.m_dodgeable || !component2.IsDodgeInvincible()))
                {
                  hitOccured = true;
                }
              }
            ...
            if (component != null)
            {
              ...
              hitData.m_statusEffect = (bool) (UnityEngine.Object) ___m_weapon.m_shared.m_attackStatusEffect ? ___m_weapon.m_shared.m_attackStatusEffect.name : "";
            ...
            ___m_weapon.m_shared.m_hitTerrainEffect.Create(pos, Quaternion.identity);   // Quaternion.identity might need to be replaced
            ___m_hitTerrainEffect.Create(pos, Quaternion.identity);
            
            if ((bool) (UnityEngine.Object) ___m_weapon.m_shared.m_spawnOnHitTerrain) {
              spawnOnHitTerrainMethod.Invoke(__instance, new object[] {pos, ___m_weapon.m_shared.m_spawnOnHitTerrain});
            }
            ...
            if ((bool) (UnityEngine.Object) ___m_weapon.m_shared.m_spawnOnHit)
              UnityEngine.Object.Instantiate<GameObject>(___m_weapon.m_shared.m_spawnOnHit, pos, Quaternion.identity).GetComponent<IProjectile>()?.Setup(___m_character, Vector3.zero, ___m_attackHitNoise, (HitData) null, ___m_weapon);
          ...
          if (!(bool) (UnityEngine.Object) ___m_spawnOnTrigger)
            return false;
          UnityEngine.Object.Instantiate<GameObject>(___m_spawnOnTrigger, Vector3.zero, Quaternion.identity).GetComponent<IProjectile>()?.Setup((Character) ___m_character, ___m_character.transform.forward, -1f, (HitData) null, ___m_weapon);
          return false;

        }

         [HarmonyReversePatch]
         public static void meleeAttack(object Instance)
         {
         }
