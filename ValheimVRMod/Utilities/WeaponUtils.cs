    ...
    public class WeaponUtils
    {
        ...
        private static readonly Dictionary<string, WeaponCollider> colliders = new Dictionary<string, WeaponCollider>
        {
            {           // AXES
                ...
                "SwordBronze", WeaponCollider.create( 
                    0,  1.523f, 0,
                    0,  0, 0,
                    0.1934575f,  2.34697f, 0.05382534f
                )}, {
                "SwordIron", WeaponCollider.create( 
                    0,  2.102f, 0,
                    0,  0, 0,
                    0.1934575f,  3.425369f, 0.05382534f
                )}, {
                "SwordIronFire", WeaponCollider.create( 
                    0,  2.102f, 0,
                    0,  0, 0,
                    0.1934575f,  3.425369f, 0.05382534f
                )}, {
                "SwordCheat", WeaponCollider.create( 
                    0,  2.102f, 0,
                    0,  0, 0,
                    0.1934575f,  3.425369f, 0.05382534f
                )}, {
                "SwordSilver", WeaponCollider.create( 
                    0,  2.158f, 0,
                    0,  0, 0,
                    0.1101757f,  3.519603f, 0.05382534f
                )}, {
                "SwordBlackmetal", WeaponCollider.create( 
                    0,  0.842f, 0,
                    0,  0, 0,
                    0.09493963f,  1.120129f, 0.01100477f
                )}, {
                "SpearWolfFang", WeaponCollider.create( 
                    0,  -9.06f, 0,
                    0,  0, 0,
                    0.3996784f,  1.445521f, 0.4638378f
                )}, {
                "SpearFlint", WeaponCollider.create( 
                    0,  0, 1.238f,
                    0,  0, 0,
                    0.08946446f,  0.05617056f, 0.1811694f
                )}, {
                "SpearChitin", WeaponCollider.create( 
                    0,  1.12f, 0.008f,
                    0,  0, 0,
                    0.01591795f,  0.8536723f, 0.09076092f
                )}, {
                "SpearElderbark", WeaponCollider.create( 
                    0,  2.0915f, 0,
                    0,  0, 0,
                    0.07673188f,  0.3863854f, 0.02554126f
                )}, {
                "SpearBronze", WeaponCollider.create( 
                    0,  2.182f, 0,
                    0,  0, 0,
                    0.07756059f,  0.425059f, 0.02554126f
                )}, {
                "SledgeStagbreaker", WeaponCollider.create( 
                    0,  2.064f, 0,
                    0,  0, 0,
                    0.5530369f,  0.5530369f, 1.284601f
                )}, {
                "SledgeIron", WeaponCollider.create( 
                    0,  1.194f, 0,
                    0,  0, 0,
                    0.7411623f,  0.3304068f, 0.2240506f
                )}, {
                "MaceBronze", WeaponCollider.create( 
                    0,  1.946f, 0,
                    0,  45, 0,
                    0.4857313f,  0.5671427f, 0.4857313f
                )}, {
                "MaceSilver", WeaponCollider.create( 
                    0,  0.53f, 0,
                    0,  0, 0,
                    0.4254949f,  0.1803948f, 0.133568f
                )}, {
                "MaceIron", WeaponCollider.create( 
                    0,  2.548f, 0,
                    0,  45f, 0,
                    0.4857313f,  0.5671427f, 0.4857313f
                )}, {
                "MaceNeedle", WeaponCollider.create( 
                    0,  1.063f, 0,
                    0,  0, 0,
                    0.4f,  0.4f, 0.4f
                )}, {
                "AtgeirBlackmetal", WeaponCollider.create( 
                    0.101f,  2.361f, 0,
                    0,  0, 0,
                    0.0777498f,  0.7300777f, 0.01543969f
                )}, {
                "AtgeirBronze", WeaponCollider.create( 
                    0,  -0.111f, -2.029f,
                    7.082f,  0, 0,
                    0.02239758f,  0.1004803f, 0.9769629f
                )}, {
                "AtgeirIron", WeaponCollider.create( 
                    0,  -0.111f, -2.029f,
                    7.082f,  0, 0,
                    0.02239758f,  0.1004803f, 0.9769629f
                )}, {
                "Battleaxe", WeaponCollider.create( 
                    -0.679f,  3.496f, -0.003f,
                    0,  0, 12.943f,
                    0.44454f,  1.314052f, 0.086121f
                )}, {
                "KnifeCopper", WeaponCollider.create( 
                    -0.042f,  0.645f, 0,
                    0,  0, 5.632f,
                    0.1822819f,  0.6237586f, 0.03287503f
                )}, {
                "KnifeFlint", WeaponCollider.create( 
                    -0.142f,  0.602f, 0,
                    0,  0, 28.779f,
                    0.2098247f,  0.6237586f, 0.03287503f
                )}, {
                "KnifeBlackMetal", WeaponCollider.create( 
                    -0.2284f,  0.3629f, -0.0032f,
                    0,  0, -0.445f,
                    0.06340086f,  0.3513995f, 0.0144201f
                )}, {
                "KnifeChitin", WeaponCollider.create( 
                    0,  0.208f, 0.027f,
                    15.689f,  0, 0,
